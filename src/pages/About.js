    ...
    <div className="about-container">
      ...
      <div className="grid-about-2">
        ...
        <p className="about-paragraph">
          ...
          quo eaque laborum officia nulla, dolorum accusantium neque recusandae
          eligendi veritatis ut deleniti maiores odit adipisci obcaecati
          cupiditate facere? Voluptate.
        </p>
      </div>
    </div>
  );
